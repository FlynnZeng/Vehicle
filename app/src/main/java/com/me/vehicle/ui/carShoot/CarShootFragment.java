...
public class CarShootFragment extends Fragment {
    ...
    private CarShootViewModel mViewModel;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(CarShootViewModel.class);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_car_shoot, container, false);
    }
